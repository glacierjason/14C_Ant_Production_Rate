function P = ProtonsCD(h,Rc,s,consts,ND)
...
for a = 1:length(Rc)
    ...
    %Si
        P.P14Si(a) = (trapz(E,phiPtot.*consts.Si28pxC14).*ND(1,1).*NSconst);
    %Ti
        P.P14Ti(a) = (trapz(E,phiPtot.*consts.Ti48pxC14).*ND(1,2).*NSconst);
    %Al
        P.P14Al(a) = (trapz(E,phiPtot.*consts.Al27pxC14).*ND(1,3).*NSconst);
    %Fe1 = Fe2O3
        P.P14Fe1(a) = (trapz(E,phiPtot.*consts.Fe56pxC14).*ND(1,4).*NSconst); 
    %Fe2 = FeO
        P.P14Fe2(a) = (trapz(E,phiPtot.*consts.Fe56pxC14).*ND(1,5).*NSconst); 
    %Mn
        P.P14Mn(a) = (trapz(E,phiPtot.*consts.Mn55pxC14).*ND(1,6).*NSconst);
    %Mg
        P.P14Mg(a) = (trapz(E,phiPtot.*consts.Mg24pxC14).*ND(1,7).*NSconst);
    %Ca
        P.P14Ca(a) = (trapz(E,phiPtot.*consts.Ca40pxC14).*ND(1,8).*NSconst);
    %Na
        P.P14Na(a) = (trapz(E,phiPtot.*consts.Na23pxC14).*ND(1,9).*NSconst);
        %P.P14Na(a) = (trapz(E,phiPtot.*consts.Na23pxC14TJ).*ND(1,9).*NSconst); 
        %spliced TENDL+JENDL
    %K
        P.P14K(a) = (trapz(E,phiPtot.*consts.K39pxC14).*ND(1,10).*NSconst);
    %P
        P.P14P(a) = (trapz(E,phiPtot.*consts.P31pxC14).*ND(1,11).*NSconst);
        %P.P14P(a) = (trapz(E,phiPtot.*consts.P31pxC14T).*ND(1,11).*NSconst); %TENDL
    %O
        P.P14O(a) = (trapz(E,phiPtot.*consts.O16pxC14).*ND(1,12).*NSconst);
    
    %Total theoretical P14 from proton spallation
    P.P14CD(a) = P.P14Si(a) + P.P14Ti(a) + P.P14Al(a) + P.P14Fe1(a) + P.P14Fe2(a) + P.P14Mn(a) + ...
        P.P14Mg(a) + P.P14Ca(a) + P.P14Na(a) + P.P14K(a) + P.P14P(a) + P.P14O(a); 
end
