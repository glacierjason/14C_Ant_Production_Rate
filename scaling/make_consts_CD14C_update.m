...
% Modified by Allie Koester and Nat Lifton -- Purdue University 2022,2024
% koestera@purdue.edu
...
% Added updated 14C PRs with corrected Greenland and New Zealand data
...
% Straight sample means calculated first for each calibration dataset 
% (Bonneville, Scotland, NZ, Greenland, Death Valley/White Mtns, Chile, Antarctica-std atm/ERA40), then site production rates.
% Values are straight means of all site PRs and standard deviations - NL 2/22

% NOT COMPOSITIONALLY DEPENDENT - QUARTZ ONLY
...
consts.P14_ref_LS = 14.5;  %nuclide-specific LSD - Trajectory Traced Rc - PC14 - Adjusted by JD April 2026
consts.delP14_ref_LS = 0.3; %nuclide-specific LSD - Trajectory Traced Rc - PC14  - Adjusted by JD April 2026
consts.P14_ref_LD = 13.11;  %nuclide-specific LSD - Geocentric dipole - PC14
consts.delP14_ref_LD = 1.21; %nuclide-specific LSD - Geocentric dipole - PC14
...
save("consts_CD14C_update",'consts');
