...
elseif flag == 2
    ...
    P14.range = [P14.min:0.02:P14.max];
    all_sample_name = sampledata.name;
    all_xrf = sampledata.xrf; %matrix of all the sample major element data
...
elseif flag == 3
    sample.sample_name = sampledata.name;
    sample.lat = sampledata.lat;
